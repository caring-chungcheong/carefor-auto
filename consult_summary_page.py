...
<style>
body{font-family:'Pretendard Variable',Pretendard,'맑은 고딕',sans-serif;margin:0;background:linear-gradient(180deg, #fbf1f4 0%, #f8f5f7 220px, #f7f9fb 560px) no-repeat, #f7f9fb;color:#222}
header{background:#fff8fa;color:#3a6f78;padding:12px 22px;border-bottom:1px solid #f5e1e7}
header h1{font-size:22px;margin:0}
.sub{font-size:14px;opacity:.85;margin-top:3px}
.wrap{padding:10px 18px 8px;max-width:900px;margin:0 auto}
h2{font-size:18px;color:#3a6f78;margin:10px 0 7px}
...
th,td{border:1px solid #b3d8df;padding:9px 12px;text-align:center}
th{background:#eef5f7;font-size:16px}
...
.back{display:inline-block;margin:0 0 6px;background:#fff0f3;color:#c17080;padding:6px 15px;border-radius:16px;text-decoration:none;font-size:14px;font-weight:bold}
